<h1 id="courier-list-2026-06">Couriers List</h1>

This endpoint allows users to retrieve a list of available courier services for a specific country.

<h2 id="http-request-courier-list-2026-06">HTTP Request (Courier List)</h2>

`GET https://api.easyparcel.com/open_api/2026-06/courier/list`

<h2 id="courier-list-requested-parameters-2026-06">Courier List Request</h2>
...
<h2 id="error-response-courier-listing-2026-06">Error Response</h2>
...
<h2 id="supported-country-codes-2026-06">Supported Country Codes</h2>
