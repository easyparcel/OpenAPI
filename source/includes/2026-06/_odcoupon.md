<h1 id="od-coupon-2026-06">OnDemand Coupon</h1>
...
<h2 id="http-request-od-coupon-list-2026-06">HTTP Request (OnDemand Coupon List)</h2>

Customers can retrieve a list of available coupon codes using the following endpoint:

`GET https://api.easyparcel.com/open_api/2026-06/ondemand/get_coupon_list`
...
<h2 id="od-coupon-request-2026-06">OnDemand Coupon Request</h2>
...
<h2 id="od-coupon-list-response-2026-06">OnDemand Coupon Response</h2>
...
<h2 id="sample-field-submit-orders-2026-06">Sample Field in Submit Orders: </h2>
