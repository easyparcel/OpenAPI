<h1 id="2026-03-reference"><span style="color: black;"> References</span></h1>
...
<h2 id="easyparcel-coupon-feature-2026-03">EasyParcel Coupon Feature</h2>
...
<h2 id="easyparcel-api-standards-2026-03">EasyParcel API Standards</h2>
...
```
<h2 id="reference-response-format-standards-2026-03">Response Format Standards</h2>
...
<h2 id="common-field-types-2026-03">Common Field Types</h2>
...
<h2 id="reference-best-practice-2026-03">Best Practices</h2>
...
8. 
<h2 id="reference-notes-api-versioning-2026-03">Notes on API Versioning</h2>

The API version is included in the URL path: `/2026-03/`

Always use the appropriate version for your implementation to ensure compatibility.


<h2 id="reference-easyparcel-api-error-handling-guide-2026-03">EasyParcel API Error Handling Guide</h2>
...
<h2 id="reference-error-response-patterns-2026-03">Error Response Patterns</h2>
...
<h2 id="reference-authentication-errors-2026-03">Authentication Errors</h2>
...
<h2 id="reference-validation-errors-2026-03">Validation Errors</h2>
...
<h2 id="reference-quotation-errors-2026-03">Quotation Errors</h2>
...
<h2 id="reference-error-messages-2026-03">Common Error Messages</h2>
...
<h2 id="reference-authentication-error-recovery-2026-03">Authentication Error Recovery</h2>
...
<h2 id="reference-common-http-status-codes-2026-03">Common HTTP Status Codes</h2>
...
<h2 id="reference-troubleshooting-guide-2026-03">Troubleshooting Guide</h2>
...
<h2 id="reference-contact-support-2026-03">Contact Support</h2>
...
<h2 id="reference-pagination-guide-easypatcel-api-2026-03">Pagination Guide for EasyParcel API</h2>
...
<h2 id="reference-pagination-od-listing-2026-03">Pagination for On-demand Listings</h2>

The on-demand listing endpoint (`/open_api/2026-03/ondemand/list`) follows the same pagination pattern as shipment listings, but uses `before_booking_number` instead of `before_shipment_number`:
...
<h2 id="reference-best-practices-2026-03">Best Practices</h2>
...
<h2 id="reference-common-issues-solutions-2026-03">Common Issues and Solutions</h2>
...
<h2 id="notes-resource-usage-2026-03">Notes on Resource Usage</h2>
...
<h2 id="reference-switching-live-2026-03">Switching to Live</h2>
