<h1 id="od-quotation-2026-03">OnDemand Quotation</h1>

<h2 id="od-quotation-overview-2026-03">OnDemand Quotation Overview</h2>
...
<h2 id="http-request-od-quotation-2026-03">HTTP Request (OnDemand Quotation)</h2>

`POST https://api.easyparcel.com/open_api/2026-03/ondemand/quotations`

<h2 id="od-quotation-request-parameters-2026-03">OnDemand Quotation Request Parameters</h2>
...
<h2 id="response-parameters-od-quotation-2026-03">OnDemand Quotation Response Parameters</h2>
...
<h2 id="sample-error-response-2026-03">Sample Error Response</h2>
...
<h2 id="code-implementation-od-quotation-2026-03">OnDemand Quotation Code Implementation Examples</h2>
...
fetch('https://api.easyparcel.com/open_api/2026-03/ondemand/quotations', {
  method: 'POST',
  headers: {
...
$ch = curl_init('https://api.easyparcel.com/open_api/2026-03/ondemand/quotations');
...
url = 'https://api.easyparcel.com/open_api/2026-03/ondemand/quotations'
headers = {
    'Content-Type': 'application/json',
    'Authorization': 'Bearer YOUR_ACCESS_TOKEN'
}
...
<h2 id="best-practices-od-quotation-2026-03">Best Practices for OnDemand Quotation</h2>
