...
1. Download the collection JSON file  
   - Postman v11 or below: <a href="/Open API Live.postman_collection.json" download="Open API Live.postman_collection.json">Here</a>  
   - Postman v12 or above: <a href="/Open API Live.postman_collection_v3.json" download="Open API Live.postman_collection_v3.json">Here</a>
2. Open Postman 
