<h1 id="od-order-submission-2026-03">OnDemand Order Submission</h1>
...
<h2 id="http-request-od-submit-order-2026-03">HTTP Request (OnDemand Submit Order)</h2>

`POST https://api.easyparcel.com/ondemand/order`

<h2 id="request-parameter-od-order-submission-2026-03">OnDemand Submit Order Request</h2>
...
<h2 id="od-submit-order-response-parameters-2026-03">OnDemand Submit Order Response</h2>
...
<h2 id="code-implementation-examples-od-submit-orders-2026-03">Code Implementation Examples</h2>
...
print(response.json())
```
<h2 id="od-submit-orders-best-practices-2026-03">Best Practices for OnDemand Submit Order</h2>
