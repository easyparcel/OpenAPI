<h1 id="tracking-status-feature-2026-03">Tracking Status Feature</h1>
...
<h2 id="http-request-tracking-status-2026-03">HTTP Request (Tracking Status)</h2>

`POST https://api.easyparcel.com/open_api/2026-03/shipment/tracking_status`
...
<h2 id="tracking-status-request-2026-03">Tracking Status Request</h2>
...
<h2 id="tracking-status-response-2026-03">Tracking Status Response</h2>
...
<h2 id="usage-notes-tracking-2026-03">Usage Notes (Tracking)</h2>
...
<h2 id="example-usa-cases-2026-03">Example Use Cases</h2>
