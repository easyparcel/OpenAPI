<h1 id="submit-orders-2026-03">Submit Orders</h1>
...
<h2 id="http-request-submit-2026-03">HTTP Request (Submit)</h2>

`POST https://api.easyparcel.com/open_api/2026-03/shipment/submit_orders`

<h2 id="submit-order-request-2026-03">Submit Order Request</h2>
