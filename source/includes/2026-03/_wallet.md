<h1 id="wallet-balance-2026-03">Wallet Balance </h1>

This endpoint allows users to retrieve their current wallet balance and free credit information.

<h2 id="http-request-wallet-2026-03">HTTP Request (Wallet)</h2>

`GET https://api.easyparcel.com/open_api/2026-03/wallet`

<h2 id="request-wallet-parameters-2026-03">Request Wallet Parameters</h2>
...
<h2 id="response-wallet-parameters-2026-03">Response Wallet Parameters</h2>
...
<h2 id="wallet-error-response-2026-03">Error Response for Wallet</h2>
...
<h2 id="usage-notes-wallet-2026-03">Usage Notes for Wallet </h2>
