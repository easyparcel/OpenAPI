...
| from_state           | string(35)  | Yes      | Sender's state            | refer to [ISO_3166](../../References/ISO_3166.md)         |
| from_country         | string(2)   | Yes      | Sender's country          | refer to [country code](../../References/country_code.md) |
| to_postcode          | string(10)  | Yes      | Receiver's postcode       | -                                                           |
| to_state             | string(35)  | Yes      | Receiver's state          | refer to [ISO_3166](../../References/ISO_3166.md)         |
| to_country           | string(2)   | Yes      | Receiver's country        | refer to [country code](../../References/country_code.md) |
...
| from_state          | string     | Sender's state                 | refer to [ISO 3166](../../References/ISO_3166.md) |
| from_country        | string     | Sender's country               | -                                                   |
| to_postcode         | string     | Receiver's postcode            | -                                                   |
| to_state            | string     | Receiver's state               | refer to [ISO 3166](../../References/ISO_3166.md) |
...
[← Previous Section Guide:Setup demo account](../Guides/oauth_authentication.md)||
[Next Paragraph → ](../Features/Shipping/2.get_insurance_quotation.md)||
[Next Section →](../Features/OnDemand/1.get_ondemand_quotation.md)
